...
namespace InventoryManagerSystem.Application.Services.Result;
...
public class ResultService
{
    ...
    public static ResultService Fail(string message) => new ResultService { IsValid = false, IsFound = true, Message = message };

    public static ResultService<T> Fail<T>(string message) => new ResultService<T> { IsValid = false, IsFound = true, Message = message };
